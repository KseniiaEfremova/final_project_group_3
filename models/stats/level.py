...
class Level(Stats, ABC):
    ...
    Attributes:
        ...
        sprites (list): A list of level sprites.
        level (int): The current level of the player.
        current_sprite (int): The index of the current sprite to be displayed.
        width (int): The width of the level sprite.
        height (int): The height of the level sprite.
        x (int): The x-coordinate of the level sprite on the game board.
        y (int): The y-coordinate of the level sprite on the game board.
        image (pygame.Surface): The image representing the current level.
        rect (pygame.Rect): The rectangular area of the level sprite.
    """

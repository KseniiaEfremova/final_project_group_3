...
class PopupWindow:
    ...
    Attributes:
        ...
        x (int): The x-coordinate of the top-left corner of the popup window (default is 0).
        y (int): The y-coordinate of the top-left corner of the popup window (default is 0).
        opened (bool): Flag indicating whether the popup window is open (default is False).
        rect (pygame.Rect): Rectangle defining the position and size of the popup window.
    """

...
class InputBox:
    ...
    Attributes:
        ...
        active (bool): Flag indicating whether the input box is currently active.
        board_instance (Board): The instance of the game board.
        is_password (bool): Flag indicating whether the input box is for a password (defaults to False).
    """
    
    def __init__(self, x, y, width, height, text, board_instance, is_password=False):
        """
        ...
        Args:
            ...
            board_instance (Board): The instance of the game board.
            is_password (bool, optional): Flag indicating whether the input box is for a password (defaults to False).
        """
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            if self.active:
                ...
                if self.is_password:
                    self.txt_surface = pygame.font.Font(None, 32).render('*' * len(self.text), True, (255, 255, 255))
                else:
                    self.txt_surface = pygame.font.Font(None, 32).render(self.text, True, (255, 255, 255))
    ...
    def draw_box(self):
        ...
        self.rect.w = width
        self.board_instance.board.blit(self.txt_surface, (self.rect.x+5, self.rect.y+4))
